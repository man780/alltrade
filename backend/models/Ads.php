...
class Ads extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_category', 'id_currency', 'id_states', 'name', 'description', 'text', 'cost', 'image', 'status'], 'required'],
            [['id_category', 'id_currency', 'id_states', 'count', 'like', 'dislike', 'rate', 'delivery', 'status', 'dcreated', 'bycreated', 'dmodified', 'bymodified', 'ddeleted', 'bydeleted'], 'integer'],
            [['text'], 'string'],
            [['cost'], 'number'],
