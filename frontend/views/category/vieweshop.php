...
<div class="category-filtr">
    ...
    <div class="categoty-right">
        ...
        <form>
            <div class="topForm">
                <div>
                    ...
                    <input type="checkbox" id="check3333"><label for="check3333" style="margin-top: 6px; margin-left: 5px;">Бесплатная доставка</label>
                    <span class="cat-cost filter-none">Цена</span>
                    <span class="cat-cost filter-none">Рейтинг магазина</span>
                    <div class="clear"></div>
                    <div class="agent">
                        <ul>
                            <a href="">
        ...
        <div>
            ...
            <p>    
                <span style="float: right; margin-top: 10px; margin-right: 5px; margin-bottom: 5px;"><a href="<?=Url::toRoute(['category/vieweshop', 'id' => $model->id]);?>" style=""><img src="<?=$layoutPath?>/images/category/list1.png"></a></span>
                <span style="float: right; margin-right: 15px; margin-top: 10px; margin-bottom: 5px;"><a href="<?=Url::toRoute(['category/listeshop', 'id' => $model->id]);?>"><img src="<?=$layoutPath?>/images/category/list2.png"></a></span>
