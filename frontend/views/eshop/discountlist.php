...
<div id="container">
    ...
    <p style="margin: 15px 0; float: right;">
        <a href="<?=Url::toRoute(['/eshop/discountlist', 'id' => $id, 'filterOrder' => $filterOrderValue]);?>" class="a" style="margin-right: 15px; font-weight: bold;"><span class="cat-cost-filter <? if ($filterOrder == 'top') { echo "filter-top"; } elseif ($filterOrder == 'bottom') { echo "filter-bottom"; } else { echo "filter-none"; } ?>">Число заказов</span></a>
        <a href="<?=Url::toRoute(['/eshop/discountlist', 'id' => $id, 'filterCost' => $filterCostValue]);?>" class="a" style="margin-right: 15px; font-weight: bold;"><span class="cat-cost-filter <? if ($filterCost == 'top') { echo "filter-top"; } elseif ($filterCost == 'bottom') { echo "filter-bottom"; } else { echo "filter-none"; } ?>">Цена</span></a>
    </p>
    <div class="clear"></div>
