...
<div id="container">
    ...
    <h2 style="color: red; margin: 0; padding: 10px; float: left">НОВИНКИ</h2>
    <p>
        <span style="float: right; margin-top: 15px; margin-right: 5px; margin-bottom: 5px;"><a href="<?=Url::toRoute(['/eshop/novelty', 'id' => $id]);?>" style=""><img src="<?=$layoutPath?>/images/category/list1.png"></a></span>
        <span style="float: right; margin-right: 15px; margin-top: 15px; margin-bottom: 5px;"><a href="<?=Url::toRoute(['/eshop/noveltylist', 'id' => $id]);?>"><img src="<?=$layoutPath?>/images/category/list2.png"></a></span>
    ...
    <!-- <p style="padding: 10px; background: #eee;">
        <a href="#" class="a" style="margin-right: 40px;">Число заказов</a><a href="#" class="a" style="margin-right: 40px;">Новинки</a><a href="#" class="a" style="margin-right: 40px;">Цена</a>
    </p> -->
