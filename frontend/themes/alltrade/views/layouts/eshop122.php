...
<body>
	...
	<div id="container">	
					...
					<div class="leftmenuindex">
						<div id="leftmenu">
							<ul style="margin: 0; padding: 0;">
								...
								<li><p class="category26"><a href="#" class="ared">Офисная</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Кабинет руководителья</a></li>
										<li><a href="#">Офисные столы</a></li>
										<li><a href="#">Офисные шкафы</a></li>
										<li><a href="#">Офисные кресло</a></li>
										<li><a href="#">Ресепшн</a></li>
										<li><a href="#">Офисный стул</a></li>
										<li><a href="#">Офисный диван</a></li>
										<li><a href="#">Офис для персонала</a></li>
										<li><a href="#">Столы для заседания</a></li>
									</ul>
								</li>

								<li>
									<p class="category27"><a href="#" class="ared">Кухни</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Кухня из ЛДСП</a></li>
										<li><a href="#">Кухня из МДФ</a></li>
										<li><a href="#">Кухня из Акрил</a></li>
										<li><a href="#">Кухня из Массив</a></li>
										<li><a href="#">Кухонные столы и стулья</a></li>
										<li><a href="#">Кухонный уголок</a></li>
									</ul>
								</li>


								<li><p class="category28"><a href="#" class="ared">Кресло</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Кресло руководителья</a></li>
										<li><a href="#">Кресло детский</a></li>
									</ul>
								</li>
								
								<li><p class="category29"><a href="#" class="ared">Спальная</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Спальный набор</a></li>
										<li><a href="#">Кровать</a></li>
										<li><a href="#">Шкафы</a></li>
										<li><a href="#">Камоды</a></li>
										<li><a href="#">Матрасы</a></li>
									</ul>
								</li>
								
								<li><p class="category30"><a href="#" class="ared">Детская</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Детский набор</a></li>
										<li><a href="#">Кровать</a></li>
										<li><a href="#">Шкафы</a></li>
								...
								<li><p class="category31"><a href="#" class="ared">Прихожая</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Прихожка</a></li>
										<li><a href="#">Камод</a></li>
										<li><a href="#">Пуфик</a></li>
									</ul>
								</li>

								<li><p class="category32"><a href="#" class="ared">Гостиная</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Стенки</a></li>
										<li><a href="#">Горки</a></li>
										<li><a href="#">Камод</a></li>
										<li><a href="#">Тумбы под ТВ</a></li>
										<li><a href="#">Столы и стулья гостинные</a></li>
									</ul>
								</li>

								<li><p class="category33"><a href="#" class="ared">Мягкая</a></p>
									<ul class="leftmenusub">
								...
								<li><p class="category34"><a href="#" class="ared">Столы и стулья</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Столы и стулья гостинные</a></li>
										<li><a href="#">Столики</a></li>
										<li><a href="#">Столы компьютерные</a></li>
										<li><a href="#">Столы письменные</a></li>
										<li><a href="#">Столы и стулья кухонные</a></li>
										<li><a href="#">Барные стулья</a></li>
									</ul>
								</li>

								<li><p class="category35"><a href="#" class="ared">Матрасы</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Матрасы детские</a></li>
										<li><a href="#">Матрасы спальные</a></li>
										<li><a href="#">Матрасы на дачу</a></li>
									</ul>
								</li>
								
								<li><p class="category36"><a href="#" class="ared">Еще мебель</a></p>
									<ul class="leftmenusub">
										<li><a href="#">Библиотеки</a></li>
										<li><a href="#">Банкетки</a></li>
										<li><a href="#">Мебель для детсада</a></li>
										<li><a href="#">Школьная мебель</a></li>
										<li><a href="#">Дачный мебель</a></li>
										<li><a href="#">Медицинская мебель</a></li>
										<li><a href="#">Гардеробный мебель</a></li>
									</ul>
								</li>
		...
		<div id="content">
			<div id="brands">
				<div class="brandstop">
					<p class="brandsp" style="margin-left: 10px;"><a href="#" style="color: red; text-decoration: none;">Хиты продаж</a></p>
			...
			<div id="brands">
				<div class="brandstop">
					<p class="brandsp" style="margin-left: 10px;"><a href="#" style="color: red; text-decoration: none;">НОВЫЕ ПОСТУПЛЕНИЯ</a></p>
				</div>
