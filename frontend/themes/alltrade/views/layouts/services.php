					...
					<div class="leftmenuindex">
						<div id="leftmenu">
							<ul style="margin: 0; padding: 0;">
								...
								<li>
									<p class="onlineshopmenu"><a href="#" class="ared">Торжественные услуги</a></p>
								...
								<li>
									<p class="onlineshopmenu"><a href="#" class="ared">Медицинские услуги</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
										<li><a href="#">1Одежда для мужчин</a></li>
										<li><a href="#">1Всё для детей</a></li>
								...
								<li>
									<p class="onlineshopmenu"><a href="#" class="ared">Авто услуги</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
										<li><a href="#">1Одежда для мужчин</a></li>
										<li><a href="#">1Всё для детей</a></li>
								...
								<li>
									<p class="onlineshopmenu"><a href="#" class="ared">Услуги для дома и сада</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
										<li><a href="#">1Одежда для мужчин</a></li>
										<li><a href="#">1Всё для детей</a></li>
								...
								<li>
									<p class="onlineshopmenu"><a href="#" class="ared">Строительные услуги</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
										<li><a href="#">1Одежда для мужчин</a></li>
										<li><a href="#">1Всё для детей</a></li>
								...
								<li><p class="onlineshopmenu"><a href="#" class="ared">Компьютерные услуги</a></p>
									<ul class="leftmenusub">
								...
								<li><p class="onlineshopmenu"><a href="#" class="ared">Спорт и развлечения</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
								...
								<li><p class="onlineshopmenu"><a href="auto.php" class="ared">Туризм и отдых</a></p>
									<ul class="leftmenusub">
										<li><a href="#">1Одежда для женщин</a></li>
										<li><a href="#">1Одежда для мужчин</a></li>
										<li><a href="#">1Всё для детей</a></li>
