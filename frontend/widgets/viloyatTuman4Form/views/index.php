...
$(document).ready(function(){
    ...
    if (winWidth > 533) {
        ...
        $('.menupvil').click(function(){
            ...
            $('#ads-id_viloyat').attr('value', value1);
            $('#orders-id_viloyat').attr('value', value1);
        ...
        $('.submenuvil > p').click(function(){    
            ...
            $('.submenuvil').css('display', 'none');
            $('#ads-id_tuman').attr('value', $(this).attr('data-value'));
            $('#orders-id_tuman').attr('value', $(this).attr('data-value'));
        });
    }
    else {
        //alert(winWidth);
...
<? 
    if ($valueViloyat) {
        $value = $valueViloyat.', '.$valueTuman;
    }
?>
<div class="form-group">
    <label for="viloyatTuman">Выберите Регион</label>
    <input id="viloyatTuman" type="text" required
        <? if ($value): ?>
            value="<?=$value;?>"
        <? endif ?>
    >
...
<div class="popupvil">        
    ...
    <div class="menuvil">
        <div style="border-right: 1px solid #ddd; width: 250px; height: 370px;">
